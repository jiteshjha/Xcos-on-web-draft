...
\usepackage{blindtext, graphicx, tabu, listings}
\lstset{
    frame=single,
    breaklines=true,
}
...
Telephone: (800) 555--1212\\
Fax: (888) 555--1212}}
%\IEEEauthorblockN{Nimish Singhal}
%\IEEEauthorblockA{Department of Information \& Communication\\ Technology\\
%Manipal Institute of Technology\\
%Manipal, Karnataka, India 576104\\
%Email: nimish.singhal@learner.manipal.edu\\}
%\and
...
\begin{figure}
    \centering
    \includegraphics[scale=0.18, trim={0 0 0 5cm},clip]{gui}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.29]{statediagram}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.18, trim={0 0 0 5cm},clip]{serveroutput}
